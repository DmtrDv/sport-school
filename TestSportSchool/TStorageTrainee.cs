...
namespace TestSportSchool
{
    ...
    public class TStorageTrainee
    {
        ...
        [DataRow("Петров Пётр Петрович", 1999, "", 01, section.Спортивный_туризм, category.I_юношеский_спортивный_разряд, "Петров Пётр Николаевич", "88005553535", "Введите правильную дату")]
